...
SRC_URI = "${KERNELORG_MIRROR}/pub/linux/kernel/v2.6/linux-${PV}.tar.bz2 \
		   http://ares.gizmoforyou-projects.com/code/OE/packages/org.openembedded.snapshot/packages/linux-libc-headers/linux-libc-headers-2.6.20/linux-libc-headers-2.6.20-r7.patch;patch=1 \
           file://procinfo.h"
